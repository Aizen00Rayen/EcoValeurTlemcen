...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // Replace the simulated delay with the real EmailJS call
    emailjs
      .send(
        "service_2c2q22l",
        "template_d1gs7rq",
      ...
      .catch((error) => {
        ...
        setLoading(false);
        alert(lang === "ar" ? "حدث خطأ أثناء إرسال رسالتكم. يرجى المحاولة مرة أخرى." : "Une erreur s'est produite. Veuillez réessayer.");
      });
  };
  ...
  const inputClass = (field) =>
    `w-full px-4 py-3 rounded-lg border ${errors[field] ? "border-red-400 bg-red-50" : "border-brown/20 bg-white"
